...
var nx = {
    ...
    CreateUserlist: function() {
        ...
        $('.discogs a').attr('href', 'https://www.discogs.com/search/?&type=release&q=' + encodeURI(API.getMedia().author + ' - ' + API.getMedia().title));
        nx.ListButtonUpdate();
    ...
    ClickUserlist: function(a) {
        ...
        //_$context.dispatch(new _$userRolloverEvent(_$userRolloverEvent.SHOW, new _$userModel(API.getUser(uid)), {x: 550, y: a.pageY }));
        username = $.trim($(a.data.param).find(".name").not(".nxtimer").text());
        a = $("#chat-input-field");
        a.val(a.val() + "@" + username + " ").focus()

        //$(".list.room .user.id-" + uid).click();
    },
    ...
    AppendUserList: function(a, b) {
        ...
        "10000" == b.role && $(".nxlist " + $previousUser).after('<div class="nxuser is-admin"><i class="icon icon-chat-admin"></i>\n' + nxUserContent + "</div>\n");
        "1000" == b.gRole || "2000" == b.gRole || "3000" == b.gRole ? $(".nxlist " + $previousUser).after('<div class="nxuser is-ambassador"><i class="icon icon-chat-ambassador"></i>\n' + nxUserContent + "</div>\n") : "5000" == b.role ? $(".nxlist " +
            $previousUser).after('<div class="nxuser is-staff"><i class="icon icon-chat-host"></i>\n' + nxUserContent + "</div>\n") : "4000" == b.role ? $(".nxlist " + $previousUser).after('<div class="nxuser is-staff"><i class="icon icon-chat-cohost"></i>\n' + nxUserContent + "</div>\n") : "3000" == b.role ? $(".nxlist " + $previousUser).after('<div class="nxuser is-staff"><i class="icon icon-chat-manager"></i>\n' + nxUserContent + "</div>\n") : "2000" == b.role ? $(".nxlist " + $previousUser).after('<div class="nxuser is-staff"><i class="icon icon-chat-bouncer"></i>\n' +
            nxUserContent + "</div>\n") : "1000" == b.role ? $(".nxlist " + $previousUser).after('<div class="nxuser is-dj"><i class="icon icon-chat-dj"></i>\n' + nxUserContent + "</div>\n") : "0" == b.role && $(".nxlist " + $previousUser).after('<div class="nxuser">\n' + nxUserContent + "</div>\n")
    },
...
function base() {
    ...
    require(['plug-modules!plug/core/Events'], function (Events) {Events.trigger('notify', 'icon-plug-dj', notice);});

}

$(".bottom__playback-controls--desktop .stream").before('<li class="community__player-item discogs" style="display: flex; margin: 0 15px 0 0;"><a href="#" target="_blank"><i class="fa fa-search" aria-hidden="true"></i></a></li>');
