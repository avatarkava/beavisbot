...
exports.handler = function (data) {
    bot.chat('Individual and room stats are being moved to our new website and will be available via API.  Stay tuned for details!');
    ...
    //    bot.chat(row['total_songs'] + ' songs ('
