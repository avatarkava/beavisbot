...
exports.handler = function (data) {
    ...
    var wordnik_apikey = "xxx"
    var uri = "http://api.wordnik.com:80/v4/word.json/" + input + "/definitions?limit=200&includeRelated=true&useCanonical=true&includeTags=false&api_key=" + wordnik_apikey;
