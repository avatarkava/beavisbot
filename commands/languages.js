...
exports.handler = function(data) {
    ...
    bot.sendChat(_.map(_.sortBy(_.pairs(languages), function(lang) { return -lang[1]; }), function(pair) { return (iso_languages[pair[0]] ? iso_languages[pair[0]] : pair[0]) + ': ' + pair[1] + (pair[1] == 1 ? ' user' : ' users')}).join(' · '));
};